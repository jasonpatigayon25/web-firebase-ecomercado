...
class Registration extends React.Component {
  ...
  handleSubmit = (e) => {
    ...
    fetch('http://localhost:5000/registration', {
      ...
      .then((data) => {
        console.log(data);
        this.setState({ registeredUser: data, registrationSuccess: true });
      })
      .catch((error) => {
        console.error('Error:', error);
      });

    this.setState({ registeredUser: { username } });
  };
            ...
            <Card.Body className="px-5">
              ...
              <Form onSubmit={this.handleSubmit}>
                ...
                <Button
                  ...
                  variant="success"
                  size="lg"
                  style={{ backgroundColor: '#05652D', color: 'white' }}
                >
                  Register
                </Button>
              </Form>
              {this.renderRegisteredUser()}
            </Card.Body>
          </Card>
        </Container>
      </div>
