          ...
          <Form>
            ...
            <InputGroup className="mb-4">
              ...
              <FormControl
                ...
                style={{ borderColor: '#98FF98', borderRadius: 0}}
              />
            </InputGroup>
            <InputGroup className="mb-4">
              <div>
            ...
            <div className="d-flex justify-content-between mx-3 mb-4">
              <Form.Check
                ...
                className="me-4"
              />
              <a href="#!" style={{ color: '#98FF98', textDecoration: 'none' }}>Forgot password?</a>
            </div>
            <Button variant="primary" className="mb-4" onClick={submit} style={{ backgroundColor: '#98FF98', width: '300px', margin: 'auto', display: 'block' }}>
              Log in
            </Button>
            <div className="text-center">
              <p>
                Don't have an account? <Link to="/signup" style={{ color: '#98FF98', textDecoration: 'none' }}>Sign up</Link>
              </p>
            </div>
          </Form>
        </Card>
